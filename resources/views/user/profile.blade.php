...
<div class="col-md-9">
    ...
    <div class="col-md-offset-2 col-md-10">
        <p class="text-danger"><small><i>Fields with an asterisk(*) are required</i></small></p>
    </div>
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'fullname', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'dob', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'age', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'gender', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'email', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'mailaddr', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'contacthp', 'class' => $error_class))
    </div>

    <div class="form-group">
        <label for="contacthome" class="control-label col-md-2 hidden-xs hidden-sm"></label>
        ...
        @include('partials.errormsg', array('field'=>'contacthome', 'class' => $error_class))
    </div>
    ...
    <div class="form-group">
        ...
        @include('partials.errormsg', array('field'=>'image', 'class' => $error_class))
    </div>
