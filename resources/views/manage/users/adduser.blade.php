...
<div class="col-lg-7 col-xs-12">
    ...
    @section ('create_user_panel_body')
        ...
        <div class="form-group">
            ...
            @include('portal.partials.errormsg', array('field'=>'username', 'class' => $error_class))
        </div>
        ...
        <div class="form-group">
            ...
            @include('portal.partials.errormsg', array('field'=>'is_admin', 'class' => $error_class))
        </div>
        ...
        <div class="form-group">
            ...
            @include('portal.partials.errormsg', array('field'=>'is_expert', 'class' => $error_class))
        </div>
    ...
    @endsection
    @include('widgets.panel', array('header'=>true, 'as'=>'create_user'))
</div>
